...
{
    internal sealed class AdvProcessWrapper : IAdvProcess
    {
        ...
        event EventHandler<ProcessExitedEventArgs> IAdvProcess.Exited
        {
            add
            {
        ...
        /// </summary>
        /// <remarks>
        ///     The ErrorDataReceived event indicates that the associated process has written to its redirected StandardError
        ///     stream.
        ...
        ///     <note>
        ///         The application that is processing the asynchronous output should call the WaitForExit method to ensure that
        ///         the output buffer has been flushed.
        ///     </note>
        /// </remarks>
        event EventHandler<ProcessOutputReceivedEventArgs> IAdvProcess.ErrorDataReceived
        {
            add
            {
        ...
        /// </summary>
        /// <remarks>
        ///     The OutputDataReceived event indicates that the associated process has written to its redirected StandardOutput
        ///     stream.
        ...
        ///     </note>
        /// </remarks>
        event EventHandler<ProcessOutputReceivedEventArgs> IAdvProcess.OutputDataReceived
        {
            add
            {
        ...
        private event EventHandler<ProcessOutputReceivedEventArgs> ProcessOutputDataReceived;

        private event EventHandler<ProcessOutputReceivedEventArgs> ProcessErrorDataReceived;
        ...
        private void Process_ErrorDataReceived(object sender, DataReceivedEventArgs e)
        {
            if (e.Data != null)
            {
                OnProcessErrorDataReceived(new ProcessOutputReceivedEventArgs(e.Data));
            }
        }

        private void OnProcessErrorDataReceived(ProcessOutputReceivedEventArgs e)
        {
        ...
        private void Process_OutputDataReceived(object sender, DataReceivedEventArgs e)
        {
            if (e.Data != null)
            {
                OnProcessOutputDataReceived(new ProcessOutputReceivedEventArgs(e.Data));
            }
        }

        private void OnProcessOutputDataReceived(ProcessOutputReceivedEventArgs e)
        {
